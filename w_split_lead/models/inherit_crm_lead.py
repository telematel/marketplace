...
class CrmLead(models.Model):
    ...
    def write(self, vals):
        ...
        if (vals.get('probability') == 100 or self.probability == 100) and (
            ...
            amount_percent = (
                (vals.get(
                    'planned_revenue') or self.planned_revenue) / 100) * float(
